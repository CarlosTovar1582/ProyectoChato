      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  DLC Electric Perù DLC EIRL, fundada en 2013, es un fabricante centrado en I+D y producción de interruptores de 
                  control industrial, como interruptores de límite, microinterruptores, interruptores sellados,
        ...
        <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Nuestra Mision</h2>
              ...
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                ...
                <div className="mt-10 max-w-xl text-xl leading-8 text-gray-700">
                  ...
                  Nuestra misión es clara, ofrecer a nuestros clientes las mejores soluciones.
                    ...
                    Electric Perù DLC es una empresa industrial que trabajando con Método y utilizando la mejora continua como herramienta de evolución constante,
                    aplicando tecnología avanzada, y Desarrollando e Innovando productos y procesos, crea valor i  ofrece soluciones técnicas
                    con servicio integrado de diseño y fabricación de componentes y productos acabados en base a perfiles de aluminio extruido.
                  </p>                
                </div>
              </div>
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-48">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-center text-lg font-semibold leading-8 text-gray-900">
              {/*Trabajamos con las Marcas mas Solicitadas del Mercado*/}
            </h2>
